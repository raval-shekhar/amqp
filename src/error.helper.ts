 ...
 */
export const requeueErrorHandler: MessageErrorHandler = (channel, msg, error) => {
 ...
 */
export const defaultNackErrorHandler: MessageErrorHandler = (channel, msg, error) => {
  channel.nack(msg, false, false);
};

export const getHandlerForLegacyBehavior = (behavior: MessageHandlerErrorBehavior) => {
  switch (behavior) {
